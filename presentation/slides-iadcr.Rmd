...
\begin{center}
  ...
  {\tt
    ...
    \textcolor{url}{R} -
  \href{https://github.com/JrEduardo/iguiR}{meetup-iadcr}
  }
\end{center}
...
Utiliza as propriedades da familía exponencial  
...
hurdle(resp ~ pi_preditor | f_preditor, dist = "poisson")
...
zeroinfl(resp ~ pi_preditor | f_preditor, dist = "poisson")
...
até o ponto $y$ da Gamma de parâmetros $theta_1$ e $\theta_2$; e $\alpha
> 0$ e $\beta > 0$ 
\end{block}\pause
