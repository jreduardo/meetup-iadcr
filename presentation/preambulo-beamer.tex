...
\setbeamerfont{headline}{size=\fontsize{5.3}{5}\selectfont}
...
\setbeamerfont{footline}{size=\fontsize{5.3}{5}\selectfont}
\makeatletter
...
\institute[]{Curso de Estatística - UFPR \\ \textbf{MEETUP USER-SP}}
